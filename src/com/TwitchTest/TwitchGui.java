...
public class TwitchGui extends JFrame{
	...
	private RandomTest test = new RandomTest();
	...
	public void addStream(String streamName){
		...
		if(test.streamExists(streamName)){
	...
	public Runnable updateStreamStatus(){	
		return new Runnable() {
			public void run() {
				test.getStreamStatus(streamInfo.getStreamsList(), 
	...
	public String getStreamInfo(String streamName){
		streamInfo = test.getJsonDataFromApi(streamName);
	...
	public void checkAndPlayStream(){
		...
		if(streamStatus.get(jStreams.getSelectedValue())){
			...
			String streamUrl = test.getStreamLinksFromPlaylist(choice, jStreams.getSelectedValue());
